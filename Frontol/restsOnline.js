...
restListForm = o.CreateForm(0,0,0,0,o.Translate("WS_SYSMENU"))
...
//вывод списка номенклатуры в виде таблицы
function showWareList(data)
{
o = new ActiveXObject("Scripting.WindowSystemObject")
...
ListView = f.CreateListView(0,0,1250,1000,o.Translate("LVS_REPORT"))
...
for(objEnum = new Enumerator(data);!objEnum.atEnd();objEnum.moveNext())
  {
        ...
        Item.SubItems(1) = strWare.name;
        Item.SubItems(2) = strWare.art;

  }
if(wareLine == 0){
  frontol.actions.showMessage("Товары отстутсвуют в базе Далион");
  return 0;
}
...
wareListForm = o.CreateForm(0,0,0,0,o.Translate("WS_SYSMENU"))
...
inputBarcodeEdit = frameInput.CreateEdit(210,60,1235,0)
inputBarcodeEdit.Font.Size = 20
